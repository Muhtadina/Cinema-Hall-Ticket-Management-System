 ...
 * @author LENOVO
 */
public class jawandetails extends javax.swing.JFrame {

    /**
     * Creates new form jawandetails
     */
    public jawandetails() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Monday 27 November");

        jLabel7.setFont(new java.awt.Font("Bauhaus 93", 0, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(102, 0, 0));
        jLabel7.setText("Wednesday 29 November");
        ...
        jLabel12.setForeground(new java.awt.Color(200, 227, 255));
        jLabel12.setText("JAWAN");
        ...
        jLabel17.setText("Actor (Protagonist): Shah Rukh Khan");

        jLabel18.setFont(new java.awt.Font("Britannic Bold", 0, 18)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(255, 255, 255));
        jLabel18.setText("Genre: Action, Thriller");

        jLabel19.setFont(new java.awt.Font("Britannic Bold", 0, 18)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Release: 7 September, 2023");

        jLabel20.setFont(new java.awt.Font("Britannic Bold", 0, 18)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(255, 255, 255));
        jLabel20.setText("Language: Hindi");

        jLabel11.setIcon(new javax.swing.ImageIcon("C:\\Users\\LENOVO\\Desktop\\Gallery\\Project Samples 215\\large\\Jawan.jpeg")); // NOI18N

        jLabel21.setFont(new java.awt.Font("Broadway", 0, 24)); // NOI18N
        jLabel21.setForeground(new java.awt.Color(200, 227, 255));
        jLabel21.setText("Synopsis");

        jLabel22.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(255, 255, 255));
        jLabel22.setText("A high-octane action thriller which outlines the emotional journey of a man who is set to rectify the wrongs in the society.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jawandetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jawandetails().setVisible(true);
            }
        });
    }
